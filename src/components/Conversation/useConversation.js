...
export const useConversation = (selectedCustomer, onConversationRead, onViewConversationRead) => {
    ...
    //                 // For other directions (like agent reactions), we'll keep one per direction
    //                 if (reaction.Direction === 0) {
    ...
    // const handleReactionMessage = (data) => {
    //     console.log("TCL: handleReactionMessage -> data", data)
    //     // Skip if this is the current user's own reaction
    //     if (data._isFromCurrentUser) {
    //         return;
    //     }
    ...
    //         // Find the message by MessageId or id
    //         const existingMsgIndex = prevData.findIndex(msg =>
    //             msg?.MessageId === data?.MessageId || msg?.id === data?.id
    //         );
    ...
    //             // Update only the reaction emojis
    //             updatedData[existingMsgIndex] = {
    //                 ...updatedData[existingMsgIndex],
    //                 ReactionEmojis: data.ReactionEmojis
    //             };
    ...
    //         // If message not found, return previous messages as is
    //         return prevMessages;
    //     });
    // };
